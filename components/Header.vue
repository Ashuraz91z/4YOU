...
<template>
    <div>
      ...
      <!-- Mobile header -->
      <header class="md:hidden fixed top-0 left-0 w-full p-4 z-50 flex justify-between items-center">
      ...
      <div 
        class="md:hidden fixed inset-0 bg-red-500 z-40 flex flex-col justify-between transform transition-transform duration-300 ease-in-out"
